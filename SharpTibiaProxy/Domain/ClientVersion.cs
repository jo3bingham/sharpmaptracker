...
namespace SharpTibiaProxy.Domain
{
    public class ClientVersion
    {
        ...
        public static readonly ClientVersion Version1077 = new ClientVersion { Number = 1077, FileVersion = "10.7.7.0", OtbmVersion = 2, OtbMajorVersion = 3, OtbMinorVersion = 55 };
        public static readonly ClientVersion Current = Version1077;
        ...
        public static ClientVersion GetFromFileVersion(string fileVersion)
        {
            switch (fileVersion)
            {
                ...
                case "10.7.7.0": return Version1077;
                default: return null;
            }
        }
